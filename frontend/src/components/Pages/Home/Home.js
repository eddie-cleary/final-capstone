...
import { Stack, Paper, Link, Button, Typography, Box, autocompleteClasses } from "@mui/material";
    ...
    <Box>
      ...
      <Box style={styles.boxContainer}>
        <Stack sx={btnContainer}>
          <Typography variant="h2" textAlign="center" fontWeight="bolder">Get Started</Typography>
          <Button variant="contained" sx={btn}>
            <Link to="/recipes/add" component={ReactLink} underline="none" color="black">
              Add a New Recipe
            </Link>
          </Button>
          <Button variant="contained" sx={btn}>
            <Link to="/recipes" component={ReactLink} underline="none" color="black">
              Browse All Your Recipes
            </Link>
          </Button>

          <Button variant="contained" sx={btn}>
            <Link to="/mealplans" component={ReactLink} underline="none" color="black">
              Create a MealPlan
            </Link>
          </Button>
          <Button variant="contained" sx={btn}>
          ...
          <Box alignContent="center" marginTop="10px">
            ...
            <Typography sx={collabCredit}>
              Created in Collaboration <br /> by: Edward Cleary, Kimberly Bryant, Chantele Lohr, and Brandon Vo
            </Typography>
          </Box>
        </Stack>
      </Box>
